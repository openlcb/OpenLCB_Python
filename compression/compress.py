#
# Perform compression in the low-unpack-memory format.
#
# usage: compress.py [ --lookback O ] [ --length L ] --name NAME inputfile outputfile
#
# NAME names the resulting variable in the output,
# inputfile is text file to be compressed
# outputfile is resulting C header file
#
# e.g. compress.py --lookback 7 --length 4 --name itwas sourcefile itwas.h
#
# see also
