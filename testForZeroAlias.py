#!/usr/bin/env python
'''
Forces repeated reallocation of alias to check for zero
...
def usage() :
    print ""
    print "Forces repeated reallocation of alias to check for zero."
    print ""
...
def once(dest, connection, identifynode, verbose) :
    ...
    # not waiting for RID or AMR to speed loop
    return dest
